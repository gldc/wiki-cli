"""wiki-cli REPL Skin — Terminal interface for Wiki.js CLI.
...
_ACCENT_COLORS = {
    ...
    "wiki": "\033[38;5;33m",  # wiki.js blue
}
...
# Icon: a small colored diamond/chevron mark
...
class ReplSkin:
    """Unified REPL skin for wiki-cli."""
    ...
    def _detect_color_support(self) -> bool:
        if os.environ.get("NO_COLOR"):
            return False
        if os.environ.get("WIKI_CLI_NO_COLOR"):
            return False
    ...
    def print_banner(self):
        ...
        brand = self._c(_CYAN + _BOLD, "wiki-cli")
